...
- 5 resources (6 URIs) (digest/current, scores/history, rubric/current, config/scrapers, stats/summary).
...
- Synthetic dataset (33 synthetic postings) committed for portability.
